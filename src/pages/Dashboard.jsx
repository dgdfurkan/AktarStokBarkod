...
export default function Dashboard() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
            ...
            <h2 className="text-2xl font-bold text-slate-800 transition-all">Aktar Pro'ya Hoş Geldiniz</h2>
            ...
            <div className="flex gap-4 mt-8">
                ...
                <button className="px-8 py-2 rounded-xl border border-slate-200 text-slate-600 font-semibold hover:bg-slate-50 transition-all">
                    Stokları İncele
                </button>
            </div>
        </div>
